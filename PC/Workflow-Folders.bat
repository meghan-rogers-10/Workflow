...
:: FIXED LOGIC: Check in descending order (reverse order required for CHOICE)
IF ERRORLEVEL 2 (
    set "BASE=Teaching"
...
:: RESEARCH STRUCTURE
:: NOTE: You can change the name of the folders below
:: Note:  To subfolder 03-Text\New Folder Name
IF /I "%BASE%"=="Research" (
